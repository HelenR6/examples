...
loader = torch.utils.data.DataLoader(
    torchvision.datasets.ImageFolder('/content/gdrive/MyDrive/sketch', preprocess),
...
np.save(f'/content/gdrive/MyDrive/model_OOD_acc/sketch/clip_accuracy.npy', accuracy_array)
